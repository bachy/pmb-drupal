...
foreach($locations_and_sections as $alocation) {
	...
	$rows[] = array(l($alocation->location->location_caption, 'pmb/browse/locations/'.$alocation->location->location_id), count($alocation->sections));
	
	/*
		TODO set path on preprocess, not on template
	*/
}
